...
public class MoneyBoxTest {
    ...
    public void testMoneyBox_It_is_amount_zero_when_amount_was_not_passed() {
        MoneyBox moneyBox = new MoneyBox(5, MoneyBox.Currency.A, MoneyBox.CurrencyType.NOTE);
    ...
    public void testMoneyBox_It_is_invalid_when_amount_less_than_zero() {
        new MoneyBox(1, MoneyBox.Currency.A, MoneyBox.CurrencyType.COIN, -1);
    }

    @Test
    public void testMoneyBox_It_is_valid_when_amount_is_zero() {
        MoneyBox moneyBox = new MoneyBox(1, MoneyBox.Currency.A, MoneyBox.CurrencyType.COIN, 0);
        Assert.assertEquals(moneyBox.getAmount(), 0);
    }

    @Test
    public void testMoneyBox_It_is_valid_when_amount_is_greater_zero() {
        MoneyBox moneyBox = new MoneyBox(1, MoneyBox.Currency.A, MoneyBox.CurrencyType.COIN, 2);
        Assert.assertEquals(moneyBox.getAmount(), 2);
    }

    @Test
    public void testMoneyBox_It_is_amount_when_amount_was_passed() {
        MoneyBox moneyBox = new MoneyBox(5, MoneyBox.Currency.A, MoneyBox.CurrencyType.NOTE, 5);
    ...
    public void testDeposit_Is_invalid_when_amount_is_bigger_than_IntegerMAX() {
        MoneyBox moneyBox = new MoneyBox(1, MoneyBox.Currency.A, MoneyBox.CurrencyType.COIN, Integer.MAX_VALUE);
        moneyBox.deposit(1);
    }

    @Test
    public void testDeposit_Is_valid_when_amount_is_zero() {
        MoneyBox moneyBox = new MoneyBox(1, MoneyBox.Currency.A, MoneyBox.CurrencyType.COIN, 5);
    ...
    public void testDeposit_Is_valid_when_amount_is_greater_zero() {
        MoneyBox moneyBox = new MoneyBox(1, MoneyBox.Currency.A, MoneyBox.CurrencyType.COIN, 1);
    ...
    public void testGetValue_is_valid_if_Value_is_valid() {
        MoneyBox moneyBox = new MoneyBox(10, MoneyBox.Currency.A, MoneyBox.CurrencyType.NOTE);
    ...
    public void testGetCurrency_is_valid_if_Currency_is_valid() {
        MoneyBox moneyBox = new MoneyBox(10, MoneyBox.Currency.A, MoneyBox.CurrencyType.NOTE);
        Assert.assertEquals(moneyBox.getCurrency(), MoneyBox.Currency.A);
    }

    @Test
    public void testGetType_is_valid_if_Type_is_valid() {
        MoneyBox moneyBox = new MoneyBox(10, MoneyBox.Currency.A, MoneyBox.CurrencyType.NOTE);
        Assert.assertEquals(moneyBox.getType(), MoneyBox.CurrencyType.NOTE);
    }
}